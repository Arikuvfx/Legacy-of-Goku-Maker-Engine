...
```
Changes/Additions:
- added decoration creator
- changed melee animation behaviour
- added halo in character creator
- added ambient sound object
- added fishing area object
- added BGS for rooms
- added some sounds
- added shadow-painting to the tileset editor
- changed ki restore behaviour when using super attacks
- added collision detection to some super attacks
- changed flying layering behaviour for the player
- changed some weather behaviours
- added super attack silhouettes
Major Bugfixes:
- a lot.
```

Version 0.2.6 - Performance Update - Hotfix
```
Changes/Additions:
- None
Major Bugfixes:
- fixed bugs in relation to the new rendering system
```
...
Major Bugfixes:
- fixed level gate blinking on player melee
- fixed super attacks on interacting with decoration objects
- fixed decoration objects turning invisible when fully zoomed out in the    room editor 
- fixed cursor issues after zooming out in the room editor
```
...
Version 0.2.0 - Hotfix 2
```
Changes/Additions:
-changed behaviour after bumping into wall
-changed layer hiding function
-non-selected layers now have lower transparency to improve visibility
-changed trigger box placing behaviour
Major Bugfixes:
-fixed problems with different grids and tiles.
...
```
Changes/Additions:
-entity creator added
-chests added
-items added
-expanded pause menu functionality
-scouter added
-room map added
-leveling system added
-stat system added
-transforming time changed
- more stuff which I probably forgot
Major Bugfixes:
- HUD fixes
- performance fixes 
- a lot of stuff
...
```
Changes/Additions:
- changed charged melee attack behaviour
- changed spam ki blasts behaviour
- changed dialoge box behaviour
- added more font letters/numbers
Major Bugfixes:
- fixed HP representation in HUD
- fixed overlapping bug in cutscene editor
- fixed NPC actor in cutscene editor
- fixed animated object layering
- fixed transformation bug with multiple costumes
- fixed input fields in cutscene editor
````
...
```
Changes/Additions:
- added idle wait animation
- added auto-ki regen
- added ki-blast barrage
...
- every character is now their own entity
- sounds added
- music object added
- ability to set music in the world map
- sound in cutscenes added
- parallax/moving background in room editor added
...
```
Changes/Additions:
- add world map feature
- add world map objects
...
```
Changes/Additions:
- add form-based portraits
- add boss hp bar
- change room cutscene editor function
- dynamic sprite size
- custom animations in cutscene editor
- be able to move position of actors in cutscene editor
- stay transformed in cutscenes
- QoL changes
...
```
Changes/Additions:
- cutscene editor added
- cutscene trigger object added
...
- NPC's added
- missions added
- mission pause menu integration
- QoL changes
...
- Implement Room Editor
- Implement Transformation System
- Implement Basic Objects
- Add Knockback when running against collision
- Add ability to test and view rooms


Major Bugfixes:
- So many that I dont even remember what exaclty anymore.
```
...
```
Changes/Additions:
-sprite system refined
-attack function overhaul
-add HUD system
-add basic assets
-transformation system implementation (w.i.p)
-add draw layer system

Major Bugfixes:
-fix kamehameha beahivour
-fix ki blast behaviour (still patching needed)
-fix overhaul gameplay logic
```
